# Navigation Guidelines - StickerSmashExpoBoiler React Native Project
...
const linking = {
  prefixes: ['stickersmashexpoboiler://', 'stickersmashexpoboiler.page.link//', 'https://stickersmashexpoboiler.page.link'],
...
export const generateDeepLink = (screen: string, params?: any): string => {
  const baseURL = 'https://StickerSmashExpoBoiler.page.link';
